...
//               <h1 className="text-3xl font-bold">{pandit.name}</h1>

//               <span className="px-3 py-1 rounded-full text-xs bg-amber-400/10 text-amber-300 border border-amber-400/20">
//                 {pandit.tag}
//               </span>
//             </div>
...
//                 {pandit.name} is a highly experienced spiritual expert
//                 with deep knowledge of Vedic rituals. He has been
//                 performing authentic ceremonies for over{" "}
//                 {pandit.experience} ensuring accuracy, devotion and
//                 traditional values in every puja.
//               </p>
//             </div>
//           </div>
//         </motion.div>
...
//               <p>✔ Verified Pandit</p>
//               <p>✔ Online / Offline Puja</p>
//               <p>✔ Same Day Booking</p>
//               <p>✔ Support Available</p>
//             </div>

//             <button className="w-full mt-8 py-3 rounded-xl bg-amber-400 text-black font-semibold hover:scale-[1.02] transition">
//               Book Pandit Now
//             </button>
